...
import { Alert, Box, Container, Grid, IconButton, InputAdornment, MenuItem, Paper, Snackbar, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, TextField, Typography } from '@mui/material';
...
const TransferHistory = () => {
  ...
  const { 
   ...
   const filteredExpenses = rows?.expenses?.filter(
    (expense) => expense.type === "wallet_cashin"
  );
...
if (isError) {
  return (
    <Box sx={{ p: 3 }}>
      <Alert severity="error">Failed to load transfers. Please try again.</Alert>
    </Box>
  );
}
  return (
    <Box sx={{
      ...
      p:2,
        ...
        <Typography variant="body1" sx={{ mb: 5, color: "text.secondary", fontSize: 12, textTransform: "capitalize" }}>
                Review your transfer activity over time
        </Typography>
      <Grid container spacing={2} alignItems="center">
        <Grid item xs={12} sm={6} md={6} lg={6}>
          <TextField
            size="small"
            label="Search by amount or transfer type or transaction id..."
            variant="outlined"
            fullWidth
            value={search}
            ...
            {filteredRows?.length> 0 ?(
              ...
              <TableRow>
                <TableCell colSpan={8} align="center" 
                  ...
                  No transfer match your filter criteria Or You have not made any transfer yet. Try adjusting your filters or search keywords or make a transfer
                </TableCell>
              </TableRow>
            )}
